...
import { ArrowLeft, Save, Play, Youtube, UploadCloud, Search, Image as ImageIcon, X, Loader2 } from "lucide-react";
...
export default function EditVideoPage({ params }: { params: Promise<{ id: string }> }) {
      ...
      .then(([catsRes, vidRes]) => {
        ...
        if (vidRes.data) {
          ...
          setForm({
            ...
            categoryId: v.categories?.[0]?.categoryId || "",
            sourceType: v.sourceType || "YOUTUBE",
            videoUrl: v.videoUrl || "",
            duration: v.duration || "",
            coverImage: v.coverImage || "",
            status: v.status || "DRAFT",
            isHighlight: v.isHighlight || false,
          });
          if (v.publishedAt) {
  ...
  if (isLoading) {
    return <div className="p-10 text-center text-gray-500">Memuat data video...</div>;
  }
    ...
    <div className="space-y-5 relative">
      <div className="flex items-center gap-3">
        ...
        <div className="flex-1">
          <h1 className="text-xl font-bold text-gray-900">Edit Video MCN Play</h1>
                      ...
                      <div 
                       ...
                       <div className="bg-white rounded-xl border border-green-200 p-4 flex justify-between items-center bg-green-50">
                          <div className="flex items-center gap-3">
                             ...
                             <div>
                                <p className="text-sm font-bold text-green-900">Video Tersimpan</p>
        ...
        <div className="xl:w-72 shrink-0 space-y-4">
          <div className="bg-white rounded-xl border border-gray-200 p-4 space-y-3">
            ...
            <div className="flex items-center gap-2 p-2 bg-purple-50 rounded-lg border border-purple-100 mt-2">
               ...
               />
               <label htmlFor="isHighlight_edit" className="text-xs font-bold text-purple-900 cursor-pointer">
                 Jadikan Highlight
               </label>
            </div>
            ...
            <div>
              ...
              <div className="flex gap-3 mb-2">
                <label className="flex items-center gap-1.5 cursor-pointer">
                  ...
                  />
                  <span className="text-sm text-gray-700">Sekarang / Sesuai Asli</span>
                </label>
                <label className="flex items-center gap-1.5 cursor-pointer">
                  <input
                    type="radio"
